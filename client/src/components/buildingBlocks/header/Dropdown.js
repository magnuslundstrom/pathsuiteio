      ...
      <div className='relative z-20'>
        ...
        {dropdown && (
          <div className='absolute top-0 left-0 mt-16 bg-white shadow-md p-5 w-72 rounded-md'>
            ...
            <div className='flex flex-col border-b border-secGray pb-2'>
              ...
              {props.isAdmin && (
                <div className='flex flex-col'>
                  ...
                  <Link to='/subscription' className='mt-1 inline-block hover-blue self-start text-red'>
                    Subscription
                  </Link>
            ...
            {/* Logout button */}
            <button className='bg-white hover-blue mt-2 border-0 cursor-pointer' onClick={() => props.onLogOut()}>
              Logout
            </button>
          </div>
        )}
