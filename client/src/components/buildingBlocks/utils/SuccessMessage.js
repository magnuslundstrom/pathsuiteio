...
// Represents the successMessage bar e.g. coming when user was successfully invited
// UseEffect to remove classes on render and unset the successMessage in redux causing it to get unMounted
