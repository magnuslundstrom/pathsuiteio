...
const SuccessMessage = (props) => {
  ...
  return (
    <div
      className="fixed min-w-full py-0 bottom-0 left-0 bg-purple z-30 h-0 duration-1000 flex items-center opacity-0"
      ref={fade}
    >
      <div className="w-8/12 mx-auto px-5">
        <p className="text-white font-semibold">
          <span className="bg-white px-5 py-2 text-green rounded-md font-semibold mr-5">
            SUCCESS <i className="fas fa-arrow-right text-green text-sm"></i>
          </span>
